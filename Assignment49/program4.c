/*
4.  Consider Sinlgy Linear Linked List to solve below problem statements
...
int main()
{
    ...
    while(1) {
        ...
        printf("\t\t 7. Count Elements Divisible by 5\n");
        ...
        switch(iChoice) {
            ...
            case 7:
                ...
                printf("There are %d Elements which are Divisible by 5", iRet);
                break;
