...
int CountNthNode(PNODE head, int pos)
{
    int iCount = 0, iCnt = 0;
...
int main()
{
    ...
    while(1) {
        ...
        printf("\t\t 7. Count Nodes at Nth Position\n");
        ...
        switch(iChoice) {
            ...
            case 7:
                ...
                scanf("%d", &iPos);
                iRet = CountNthNode(head, iPos);
                printf("\nNumber of nodes at every %dth position is: %d\n", iPos, iRet);
                break;
